...
<body class="app sidebar-mini" data-url="<?= url() ?>">
        ...
        <div class="page-main">
            ...
            <aside class="app-sidebar doc-sidebar">
                ...
                <ul class="side-menu">
                    ...
                    <li>
                        <a class="side-menu__item" href="<?= url('/admin/negotiations/home'); ?>"><i class="side-menu__icon fa fa-money"></i><span class="side-menu__label">Negociações</span></a>
                    </li>
                    <?php if (user()->level >= 3) : ?>
                        <?php if (user()->level >= 5) : ?>
                            <li>
                                <a class="side-menu__item" href="<?= url('/admin/users/home'); ?>"><i class="side-menu__icon fa fa-user"></i><span class="side-menu__label">Usuários</span></a>
                            </li>
                        <?php endif; ?>
                        <li>
                            <a class="side-menu__item" href="<?= url('/admin/sellers/home'); ?>"><i class="side-menu__icon fa fa-user-plus"></i><span class="side-menu__label">Vendedores</span></a>
                        </li>
                        <li>
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fa fa-cogs"></i><span class="side-menu__label">Premissas Gerais</span><i class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <li><a class="slide-item" href="<?= url('/admin/funnels/home'); ?>">Funil de Venda</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fa fa-list"></i><span class="side-menu__label">Relatórios</span><i class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">
    ...
    <script src="<?= theme('/assets/js/custom/modal-seller-notification.js', CONF_VIEW_ADMIN); ?>"></script>
    <?= $v->section("scripts"); ?>
</body>
