                                    ...
                                    <?php if ($futureArr) : ?>
                                        <?php foreach ($futureArr as $negFuture) : ?>
                                            <tr class="bg-dark text-white">
                                                ...
                                                <td><?= infoSellerID($negFuture->seller_id) ? infoSellerID($negFuture->seller_id)->fullName() : ""; ?></td>
                                                ...
                                                <?php if (user()->level >= 5) : ?>
                                                    <td>
                                                        <a href="#" class="btn btn-danger btn-sm" data-post="<?= url("/admin/clients/delete/{$negFuture->client_id}"); ?>" data-action="delete" data-confirm="ATENÇÃO: Tem certeza que deseja excluir a negociação relacionada ao cliente? Essa ação não pode ser desfeita!" data-client_id="<?= $negFuture->client_id; ?>" title="Excluir"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                <?php endif; ?>
                                            </tr>
                                        <?php endforeach; ?>
