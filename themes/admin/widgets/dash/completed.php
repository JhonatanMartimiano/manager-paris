                ...
                <div class="card m-b-20">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center justify-content-center">
                            ...
                            <form class="form-inline ajax_off mb-1 mx-auto" action="<?= url('/admin/dash/completed'); ?>" method="post">
                                    ...
                                    <?php if ($completedOrdersArr) : ?>
                                        <?php foreach ($completedOrdersArr as $negCompleted) : ?>
                                            <tr class="bg-success text-white">
                                                ...
                                                <td><?= infoSellerID($negCompleted->seller_id) ? infoSellerID($negCompleted->seller_id)->fullName() : ""; ?></td>
                                                ...
                                                <?php if (user()->level >= 5) : ?>
                                                    <td>
                                                        <a href="#" class="btn btn-danger btn-sm" data-post="<?= url("/admin/clients/delete/{$negCompleted->client_id}"); ?>" data-action="delete" data-confirm="ATENÇÃO: Tem certeza que deseja excluir a negociação relacionada ao cliente? Essa ação não pode ser desfeita!" data-client_id="<?= $negCompleted->client_id; ?>" title="Excluir"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                <?php endif; ?>
                                            </tr>
                                        <?php endforeach; ?>
