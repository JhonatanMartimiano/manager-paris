                ...
                <div class="card m-b-20">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center justify-content-center">
                            ...
                            <form class="form-inline ajax_off mb-1" action="<?= url('/admin/dash/inNegotiations'); ?>" method="post">
                                    ...
                                    <?php if ($inNegotiationsArr) : ?>
                                        <?php foreach ($inNegotiationsArr as $negInNegotiations) : ?>
                                            <tr class="bg-info text-white">
                                                ...
                                                <td><?= infoSellerID($negInNegotiations->seller_id) ? infoSellerID($negInNegotiations->seller_id)->fullName() : ""; ?></td>
                                                ...
                                                <?php if (user()->level >= 5) : ?>
                                                    <td>
                                                        <a href="#" class="btn btn-danger btn-sm" data-post="<?= url("/admin/clients/delete/{$negInNegotiations->client_id}"); ?>" data-action="delete" data-confirm="ATENÇÃO: Tem certeza que deseja excluir a negociação relacionada ao cliente? Essa ação não pode ser desfeita!" data-client_id="<?= $negInNegotiations->client_id; ?>" title="Excluir"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                <?php endif; ?>
                                            </tr>
                                        <?php endforeach; ?>
